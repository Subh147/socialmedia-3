...
{/* <!DOCTYPE html> */}
    ...
    <body className="bg-blue 600 ">    
        <div className="container flex flex-col mx-auto bg-blue 600">
            <aside className="group/sidebar flex flex-col w-[100px]  transition-all duration-300 ease-in-out my-36 ml-10 rounded-2xl  fixed z-40 inset-y-0 left-0 bg-lime-200   sidenav fixed-start loopple-fixed-start border-r-2 shadow-2xl shadow-gray-600 " id="sidenav-main"><div className="flex shrink-0 px-8 items-center justify-between h-[3px]">
        ...
        <div className=" relative pl-5 my-4 mr-5">
            <div className="flex flex-col w-full font-medium ">

            {/* <!-- menu item --> */}
            <NavLink to="/home" className="hover:bg-slate-400  rounded-xl  mb-2" >
            ...
            {/* <!-- menu item --> */}
            <NavLink to="/private" className="hover:bg-slate-400 rounded-xl mb-2" onClick={animation}>
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem] gap-3">
                <MdAddCircleOutline className="text-4xl mx-auto" id="logo"/>
                {/* <NavLink to="/search" className="active:text-blue-600 text-2xl   ">Search</NavLink> */}
                {/* <h1 className="text-2xl hover:text-orange-500 transition ease-in-out">Create Post</h1> */}
                </span>
            </NavLink>

            <NavLink to="/search" className="hover:bg-slate-400 rounded-xl  mb-2">
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem] gap-3 ">
                <FaSearch className="text-4xl  mx-auto" id="logo"/>
                {/* <NavLink to="/search" className="active:text-blue-600 text-2xl   ">Search</NavLink> */}
            ...
            <NavLink to="/private2" className="hover:bg-slate-400 rounded-xl  mb-2">
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem] gap-3">
            ...
            <NavLink to="/private3" className="hover:bg-slate-400 rounded-xl  mb-2">
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem] gap-3">
                <FaBookmark className="text-4xl mx-auto" id="logo"/>
                {/* <NavLink to="/search" className="active:text-blue-600 text-2xl   ">Search</NavLink> */}
                {/* <h1 className="text-2xl  hover:text-orange-500 transition ease-in-out">Save Posts</h1> */}
                </span>
            </NavLink>

            <NavLink to="/private4" className="hover:bg-slate-400 rounded-xl  mb-2">
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem] gap-3">
                <FaFacebookMessenger className="text-4xl mx-auto" id="logo"/>
                {/* <NavLink to="/search" className="active:text-blue-600 text-2xl   ">Search</NavLink> */}
           ...
           
            {
                ...
                <span className="relative z-10 font-bold " >Sign In</span>
                 ...
                 <div className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem]  gap-3 hover:bg-slate-400 rounded-xl" onClick={handleNavigate2}>
             <FiLogIn className="text-4xl px-auto"/>
                {/* <span className="relative z-10  text-2xl" >Log In</span> */}
             </div>
            </div> :
             <div className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] gap-3 hover:bg-slate-400 rounded-xl" onClick={handleLogout}>
             <FiLogOut className="text-4xl ml-2"/>
